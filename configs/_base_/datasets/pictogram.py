dataset_info = dict(
    dataset_name='pictogram',
    paper_info=dict(
        author='9jodae',
        title='2D Pictogram Pose Estimation: New Benchmark and '
        'State of the Art Analysis',
        container='Korea univ INISW Academy,9jodae',
        year='2024',
        homepage='https://www.notion.so/2realzoo/9-ab2ff5984ee845a1aa857ce3807027b7',
    ),
    keypoint_info={
        0:
        dict(
